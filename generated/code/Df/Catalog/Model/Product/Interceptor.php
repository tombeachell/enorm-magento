<?php
namespace Df\Catalog\Model\Product;

/**
 * Interceptor class for @see \Df\Catalog\Model\Product
 */
class Interceptor extends \Df\Catalog\Model\Product implements \Magento\Framework\Interception\InterceptorInterface
{
