<?php
namespace Df\Config\Model\Config\Structure;

/**
 * Interceptor class for @see \Df\Config\Model\Config\Structure
 */
class Interceptor extends \Df\Config\Model\Config\Structure implements \Magento\Framework\Interception\InterceptorInterface
{
