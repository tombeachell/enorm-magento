...
/**
 * Interceptor class for @see \Magento\UrlRewrite\Model\UrlRewrite
 */
class Interceptor extends \Magento\UrlRewrite\Model\UrlRewrite implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $resource, $resourceCollection, $data, $serializer);
    }
