<?php
namespace Magento\CatalogInventory\Block\Adminhtml\Form\Field\Stock;

/**
 * Interceptor class for @see \Magento\CatalogInventory\Block\Adminhtml\Form\Field\Stock
 */
class Interceptor extends \Magento\CatalogInventory\Block\Adminhtml\Form\Field\Stock implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Form\Element\Factory $factoryElement, \Magento\Framework\Data\Form\Element\CollectionFactory $factoryCollection, \Magento\Framework\Escaper $escaper, \Magento\Framework\Data\Form\Element\TextFactory $factoryText, \Magento\Framework\Registry $coreRegistry, array $data = array())
    {
        $this->___init();
        parent::__construct($factoryElement, $factoryCollection, $escaper, $factoryText, $coreRegistry, $data);
    }
