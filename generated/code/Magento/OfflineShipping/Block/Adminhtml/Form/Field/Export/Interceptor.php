<?php
namespace Magento\OfflineShipping\Block\Adminhtml\Form\Field\Export;

/**
 * Interceptor class for @see \Magento\OfflineShipping\Block\Adminhtml\Form\Field\Export
 */
class Interceptor extends \Magento\OfflineShipping\Block\Adminhtml\Form\Field\Export implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($factoryElement, $factoryCollection, $escaper, $backendUrl, $data);
    }
