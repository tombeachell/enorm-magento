<?php
namespace Magento\Msrp\Block\Adminhtml\Product\Helper\Form\Type\Price;

/**
 * Interceptor class for @see \Magento\Msrp\Block\Adminhtml\Product\Helper\Form\Type\Price
 */
class Interceptor extends \Magento\Msrp\Block\Adminhtml\Product\Helper\Form\Type\Price implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Form\Element\Factory $factoryElement, \Magento\Framework\Data\Form\Element\CollectionFactory $factoryCollection, \Magento\Framework\Escaper $escaper, \Magento\Msrp\Model\Config $config, $data = array())
    {
        $this->___init();
        parent::__construct($factoryElement, $factoryCollection, $escaper, $config, $data);
    }
