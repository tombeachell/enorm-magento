...
class Interceptor extends \Magento\Tax\Block\Adminhtml\Rate\Title\Fieldset implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\Data\Form\Element\Factory $factoryElement, \Magento\Framework\Data\Form\Element\CollectionFactory $factoryCollection, \Magento\Framework\Escaper $escaper, \Magento\Tax\Block\Adminhtml\Rate\Title $title, $data = array())
    {
        $this->___init();
    ...
    public function addField($elementId, $type, $config, $after = false, $isAdvanced = false)
    {
        ...
        if (!$pluginInfo) {
            return parent::addField($elementId, $type, $config, $after, $isAdvanced);
        } else {
